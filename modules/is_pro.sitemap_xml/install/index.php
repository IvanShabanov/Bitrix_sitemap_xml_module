...
Class is_pro_sitemap_xml extends CModule
{
	public function __construct()
	{
		...
		if(file_exists(__DIR__."/version.php")){
			...
			$this->MODULE_NAME 		   = Loc::getMessage("ISPRO_SITEMAP_XML_NAME");
			$this->MODULE_DESCRIPTION  = Loc::getMessage("ISPRO_SITEMAP_XML_DESC");
			$this->PARTNER_NAME 	   = Loc::getMessage("ISPRO_SITEMAP_XML_PARTNER_NAME");
			$this->PARTNER_URI  	   = Loc::getMessage("ISPRO_SITEMAP_XML_PARTNER_URI");
		}
		return false;
	}
